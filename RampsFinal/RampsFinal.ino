 ...
 * 
 * The code allows the robot to be controlled via the serial interface.
 */
...
//=====================================
                               //  x     y     z        Schritte
const long STEP_TO_POS[24][3] = { {80, 2055, 2765},     // 0 - Stockwerk 1, Pos 1
                                  {75, 1160, 2715},     // 1 - Stockwerk 1, Pos 2
                                  {1030, 2010, 2750},   // 2 - ...
                                  {1040, 1175 , 2665},   // 3
                                  {1970, 2045, 2710},   // 4
                                  {1960, 1145, 2655},   // 5
                                  {150, 2100, 5325},     // 6 - Stockwerk 2, Pos 1
                                  {150, 1210, 5275},     // 7 - Stockwerk 2, Pos 2
                                  {1035, 2090, 5290},   // 8
                                  {1050, 1220, 5250},   // 9
                                  {1990, 2080, 5300},   // 10
                                  {2000, 1200, 5215},   // 11
