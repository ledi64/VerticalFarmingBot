...
# Erzeugt Hilfe bzw. Anleitungsseite als Popup Fenster
# def popup_help():
#     
#     help_popup = Tk()
#     help_popup.wm_title("Help")
#     help_popup.config(background="#BCF5A9", height=200, width = 400)
#     
#     titleframe = Frame(help_popup)
#     titleframe.grid(row=0, column = 0, pady = 10, padx = 10)
#     title = Label(titleframe, text="How it works", font=('Helvetica', 15, 'bold'))
#     title.grid(row = 0, column = 0, padx = 10, pady = 10)
#     
#     exitbutton = Button(help_popup, text = "Exit Help", bg="#FF0000", command=help_popup.destroy)
...
# REIHE 3
    ...
    space_frame1.grid(row=1, column=0)
    
    data_frame2 = Frame(monitoring_f)
    data_frame2.grid(row=2, column=0)
    
    data_frame3 = Frame(monitoring_f)
    data_frame3.grid(row=0, column=1)
    
    space_frame1 = Frame(monitoring_f, height=10, background="#FFFFFF")
    space_frame1.grid(row=1, column=1)
    
    data_frame4 = Frame(monitoring_f)
    data_frame4.grid(row=2, column=1)
    ...
    control_frame = Frame(control_f, background="#FFFFFF")
    control_frame.grid(row=0, column=0, padx=10, pady=10)
    
    irrigation_frame = Frame(control_f, background="#FFFFFF")
    irrigation_frame.grid(row=1, column=0, padx=10, pady=10)
    
    nutrients_frame = Frame(control_f, background="#FFFFFF")
    nutrients_frame.grid(row=2, column=0, padx=10, pady=10)
    
    circulation_frame = Frame(control_f, background="#FFFFFF")
    circulation_frame.grid(row=3, column=0, padx=10, pady=10)
    
    # control
    control_frame_label = Label(control_frame, bg="#FFFFFF", text="CONTROL", font=('Helvetica', 12))
    ...
    command_text_old = Entry(control_frame_spacer, width=10, text="old")
    command_text_old.grid(row=0, column=1, padx=10, pady=5)
    command_text_new = Entry(control_frame_spacer, width=10, text="new")
    ...
    #fan_growing_button_on = Button(circulation_fan_frame, height=1, width=1, background = "#84E752", highlightthickness = 0, bd = 0, command=lambda:[print("Starting vents for the growing floors..."),
     #                                                                                                                                                control_p.start_circulation(13, 2000),
      #                                                                                                                                               control_p.start_circulation(10, 2000)
       #                                                                                                                                              ])
    #fan_growing_button_on.grid(row=2, column = 1, padx=5, pady=2)
    #fan_growing_button_off = Button(circulation_fan_frame, height=1, width=1, background = "#E75252", highlightthickness = 0, bd = 0, command=lambda:[print("Stopping vents for the growing floors..."),
    #                                                                                                                                                  control_p.stop_circulation(13),
    #                                                                                                                                                  control_p.stop_circulation(10)
    #                                                                                                                                                  ])
    #fan_growing_button_off.grid(row=2, column = 2, padx=5, pady=2)
    ...
    #check_boxes_label = Label(light_f, background="#FFFFFF", text="Checkboxes", font=('Helvetica', 7))
    #check_boxes_label.grid(row=1, column=0, padx=10, pady=5)
    ...
    snd_box = Checkbutton(check_boxes_frame, text="second", bg="#FFFFFF", bd=0, relief=FLAT, width=6, variable=state_light_second, font=('Helvetica', 10))
    snd_box.grid(row=0, column=1, padx=10, pady=5)
    fst_box = Checkbutton(check_boxes_frame, text="first", bg="#FFFFFF", bd=0, relief=FLAT, width=6, variable=state_light_first, font=('Helvetica', 10))
    ...
    #light_frame_spacer = Frame(light_f, background="#D8D8D8", width=554, height=610)
    #light_frame_spacer.grid(row=1, column=1)
